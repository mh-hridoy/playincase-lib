export function contentHtml(email : string, title : string, message : string, typeCategory : string, downloadLink : string) {
  return `
...
<table id="u_content_heading_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 class="v-line-height v-font-size" style="margin: 0px; line-height: 130%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 24px;">
    <div><strong>${title}</strong><br /></div>
  </h1>
      </td>
    </tr>
  </tbody>
...
<table id="u_content_text_3" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 170%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;">If you have any questions, please email us at customer@playincase.com or visit our FAQS, you can also chat with a reel live human during our operating hours. They can answer questions about your account</p>
  </div>
...
<table id="u_content_text_4" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 170%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;">you have received this email as a registered user of <a rel="noopener" href="https://www.playincase.com" target="_blank">playincase.com</a> can <a rel="noopener" href="https://www.unlayer.com" target="_blank">unsubscribe</a> from these emails here. 2261 Market Street #4667 San Francisco, CA 94114 All rights reserved</p>
  </div>
